(function() {
  ...
  // FYP Project Report (Dissertation) - Food Ordering System for the GMIT Catering Company (Ronan Connolly, Vladislav Marisevs 2016)
  app.get('/fyp-project-report', function(req, res) {
    res.sendfile(__dirname + '/external-docs/Food Ordering System for the GMIT Catering Company.pdf');
  });
